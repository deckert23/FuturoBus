<?php
	//funcion que valida si un campo esta vacio o null

	function isNull($nombre, $user, $pass, $pass_con, $email){
		
            //si alguno es null retorno true
	...
	// funcion que valida si mailque sea de tipo valido
        ...
        function validaget($var1)
	{
        ...
        //funcion para poner limites a los elementos
	...
	function enviarEmail($email, $nombre, $asunto, $cuerpo){
		...
		$mail->isSMTP();
		$mail->SMTPAuth = true;
		$mail->SMTPSecure = 'Ninguno';
		$mail->Host = 'smtp.gmail.com';
		$mail->Port = '587';
		
		$mail->Username = 'deckert23@gmail.com';
		$mail->Password = '';
		
		$mail->setFrom('deckert23@gmail.com', 'Sistema de Usuarios');
